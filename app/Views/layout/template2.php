...
<head>
    ...
    <!-- Favicon -->
    <link href="csspetshop/img/iconregister.png" rel="icon">
...
<body class="d-flex flex-column h-100">
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <a class="navbar-brand" href="dashboard">Petshop Miracle</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/daftarpelanggan">List Pelanggan</a>
                    </li>
                    <li class="nav-item">
